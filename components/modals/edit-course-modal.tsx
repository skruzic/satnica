...
export const EditCourseModal = () => {
  ...
  useEffect(() => {
    if (course) {
      ...
      form.setValue('type', course.type);
      form.setValue('hours', course.hours);
      form.setValue('groups', course.groups);
      form.setValue('students', course.students);
      form.setValue('scale', course.scale);
    }
  }, [form, course]);
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    storage.editCourse(values as Course);
    form.reset();
    onClose();
  };
